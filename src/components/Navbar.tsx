...
const Header = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-10 px-4 py-2 bg-[#1e4b6e] border-b border-gray-100">
        ...
        {/* Mobile Side Panel */}
        <div
          className={`lg:hidden fixed top-0 right-0 h-full w-64 bg-[#1e4b6e] transform transition-transform duration-300 ease-in-out z-50 ${
